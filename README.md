...
No último desafio, foi solicitado desenvolver mais uma aplicação, a GoRestaurant, só que dessa vez a versão mobile para o cliente. Com o objetivo de criar um pequeno app para pedidos de comida.
